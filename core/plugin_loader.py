...
def register_all_plugins(kernel: Kernel, plugins_dir: Optional[Path] = None, force_reload: bool = False) -> Dict[str, List[str]]:
    """
    ...
    for plugin_dir in plugins_dir.iterdir():
        ...
        try:
            ...
            if plugin:
                ...
                logger.info("Registered plugin using Semantic Kernel's add_plugin",
                           plugin=plugin_name,
            ...
            logger.error("Failed to register plugin using Semantic Kernel's add_plugin",
                        plugin=plugin_name,
                        error=str(e),
...
def get_plugin_function(
    ...
    try:
        ...
        logger.error("Failed to get plugin function",
                    plugin=plugin_name,
